...
function Hero() {
    ...
    <header className='navbar_header'>
            <img src={logo} alt="Taskify_logo" className='logo'/>
        ...
        </header> <div className="HeroLandingPage">
        

      <section className='Hero_start'>
            <div className='reviews'></div>
            <h1 className='main_title'>Every big goal starts with a small task.</h1>
            <p className='stay_focused'>Stay focused, stay organized, and make every day count with your new task manager.</p>
            <button className='Hero_button'>Get startesd</button>
        </section>
